...
const tollywoodHero = ["dev", "jeet", "Jishu", "Abir"];
const bollywoodHero = ["Kartic", "Aditay", "Ritwaik", "salman"];

// const allHeros = tollywoodHero.concat(bollywoodHero);  // it can create an another array, with combine all the elememts of two array

// console.log(allHeros);


const allHeros = [...bollywoodHero, ...tollywoodHero];
console.log(allHeros);
