...
//     dest [key] = Car[key];                // object cloning using iteration methode
// }

// console.log (dest)

let dest = Object.assign({}, Car);                //object cloning using Assign methode
console.log(dest) 


let area = {...Car}                                      // object cloing using spread methode
console.log(area)
...
let myName = `mohit
kumar 
paul `                                    // Template literal ` ` to get the string as order as get the value from console
